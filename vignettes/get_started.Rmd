...
`readthis` contains methods for bulk reading of output files from some other programs. To see the list of  functions implemented in the package go to [readthis/Reference](https://pawelqs.github.io/readthis/reference/index.html).
